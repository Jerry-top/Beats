...
import com.dss.beats_music.databinding.ActivityVerifyCodeBinding
...
import com.dss.beats_music.network.bean.SendVerifyCodeResult
...
class VerifyCodeActivity : BaseActivity() {
    ...
    private fun resetPassword(phone: String, password: String, captcha: String) {
        loginService.resetPassword(phone, password, captcha)
            .enqueue(object : OkCallback<LoginResult>() {
