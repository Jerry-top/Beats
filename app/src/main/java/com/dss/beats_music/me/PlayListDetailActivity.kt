...
import com.dss.beats_music.adapter.PlayListAdapter
import com.dss.beats_music.adapter.diff.SongDiffCallback
import com.dss.beats_music.databinding.ActivityPlayListDetailBinding
import com.dss.beats_music.event.PlayListUpdateEvent
import com.dss.beats_music.me.viewmodel.PlayListDetailViewModel
import com.dss.beats_music.me.viewmodel.PlayListDetailViewModelFactory
import com.dss.beats_music.util.*
...
//                                        )
        ...
        /*playAllView.setOnClickListener {
            ...
            if(songs.size != 0){
                _root_ide_package_.com.example.competition01.util.SongPlayer.play(songs[0].toPlayerSong(),songs.toPlayerSongList())
            }
        }*/
      ...
      /*  adapter.setOnItemClickListener { _, _, position ->
            ...
            Log.e(TAG, " 点击歌曲：$song")
            if(!flag){
                _root_ide_package_.com.example.competition01.util.SongPlayer.play(song.toPlayerSong(),songList.toPlayerSongList())
                flag = true
            }else{
                _root_ide_package_.com.example.competition01.util.SongPlayer.play(song.toPlayerSong())
            }
        }*/
